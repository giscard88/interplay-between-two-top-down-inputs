...
pylab.title('correlation of L5 beta and weight change')
pylab.ylabel('normalized beta power')
pylab.xlabel('weight change')


#pylab.subplot(2,1,2)    
#pylab.scatter(reference_np_p, gammas, s=10,c='b',edgecolors='none')
pylab.savefig('/local2/STDP_prune_refined/figs/beta_L5.png')
pylab.savefig('/local2/STDP_prune_refined/figs/beta_L5.eps')
pylab.show()
