...
fp=open('varf/lfp_'+'super_'+flag_super+'_deep_'+flag_deep+'_'+str(msd)+'_'+varf+'.json','w')
json.dump(lfp,fp)
fp.close()
...
fp=open('varf/lfp_l5_'+'super_'+flag_super+'_deep_'+flag_deep+'_'+str(msd)+'_'+varf+'.json','w')
json.dump(lfp_l5,fp)
fp.close()



fp=open('varf/spikes_'+'super_'+flag_super+'_deep_'+flag_deep+'_'+str(msd)+'_'+varf+'.json','w')
json.dump(spikes,fp)
fp.close()

fp=open('varf/weights_'+'super_'+flag_super+'_deep_'+flag_deep+'_'+str(msd)+'_'+varf+'.json','w')
